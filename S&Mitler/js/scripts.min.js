...
$(function(){$("#my-menu").mmenu({navbar:{title:'<img src="img/logo-top.svg" alt="S&Mitler">'},extensions:["position-right","theme-black","effect-menu-slide","pagedim-black"]});var e=$("#my-menu").data("mmenu");function s(){$(".carousel-services-composition .h3").equalHeights(),$(".carousel-services-list").equalHeights()}e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-services").on("initialize.owl.carousel",function(){setTimeout(function(){$(".carousel-services-item").each(function(){var e=$(this),s=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-img").css("height",s)})},100)}),$(".carousel-services").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3}}}),$(".carousel-services-item .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),s(),window.onresize=function(){s()},$("select").selectize(),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").css("display","none").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({items:1,loop:!0,smartSpeed:700,nav:!1,autoHeight:!0}),$(".partners").owlCarousel({items:4,loop:!0,smatrSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>'],responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:4}}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").on("click",function(){$("html, body").stop().animate({scrollTop:0},1e3)}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")})});