...
$(function(){$("#my-menu").mmenu({extensions:["theme-black","position-right","pagedim-black","fx-menu-slide"],navbar:{title:'<img src="img/logo-top.svg" alt="S&Mitler">'}});var e=$("#my-menu").data("mmenu");e.bind("open:finish",function(){setTimeout(function(){$(".hamburger").addClass("is-active")},100)}),e.bind("close:finish",function(){setTimeout(function(){$(".hamburger").removeClass("is-active")},100)}),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){$(".carousel-services-item").each(function(){var e=$(this),s=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-imge").css("min-height",s),$(".carousel-services-content .h3").equalHeights(),$(".carousel-services-list").equalHeights()})},100)}),$(".carousel-services").owlCarousel({loop:!0,items:3,smartSpeed:700,nav:!0,dots:!1,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3}}}),$(".carousel-services-composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$("#services").selectize(),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,dots:!0,autoHeight:!0}),$(".partners").owlCarousel({loop:!0,items:4,smartSpeed:700,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>'],responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:4}}}),$(window).scroll(function(){var e=$(this);e.scrollTop()>e.height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html").stop().animate({scrollTop:0},1e3)})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});
(function ($) {
